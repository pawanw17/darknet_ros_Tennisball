...
#include <darknet_ros_msgs/TennisNeuron.h>
...
class YoloObjectDetector
{
 ...
 private:
  ...
  ros::Publisher baller_;
  darknet_ros_msgs::TennisNeuron tennisBallResults_;
    std_msgs::String tennismsg;
//    std::stringstream ss;
//    ss << "Tennis Ball";
//    tennismsg.data = "helllo";
  //std_msgs::Int8 numnum; 
